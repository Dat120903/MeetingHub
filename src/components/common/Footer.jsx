    ...
    <footer className="bg-gray-800 text-gray-300 py-8 mt-auto">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">MeetingHub</h3>
            <p className="mb-4">Hệ thống quản lý phòng họp hiện đại, giúp tổ chức cuộc họp hiệu quả và tiết kiệm thời gian.</p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p>&copy; {new Date().getFullYear()} MeetingHub. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  );
